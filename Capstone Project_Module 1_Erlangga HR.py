...
'''))
                            if gender == '': 
                                ...
                                print('Angka yang anda masukkan tidak sesuai. Harap isi kembali.')
                                create = ()
                else:
                ...
                print('\nHarap masukkan input dengan Angka yang sesuai.')
                print('\nKembali ke Fungsi Create. 2\n')
                create = ()
    
        except:
            print('\nHarap masukkan input dengan Angka yang sesuai.')
            print('\nKembali ke Fungsi Create. 3\n')
            create = ()
...
'''))
                        ...
                        print('\nData yang diinput tidak ada di database Pegawai.2')
                        print('\nKembali ke Fungsi Update.\n')
                        konfirmasi = ()
                else:
                    print(f'Data yang anda input adalah berikut: {read_NIP}. Data tidak sesuai dengan ketentuan.')
                ...
                print('\nHarap masukkan input dengan Angka yang sesuai.1')
                print('\nKembali ke Fungsi Update.\n')
                konfirmasi = ()
        
        except:
            print('\nHarap masukkan input dengan Angka yang sesuai.')
            print('\nKembali ke Fungsi Update. 3\n')
            konfirmasi = ()
        ...
        try:
            if int(delete) == 1:
                ...
                if len(read_NIP) == 6 and int(read_NIP) < 230000:
                    ...
                    for i in DataPegawai:
                        try:
                            if i['NIP'] == int(read_NIP):
                                ...
                                print('\nTidak ditemukan Data Pegawai dengan NIP tersebut. 1')
                                print('\nKembali ke Fungsi Delete.\n')
                                read_NIP = ()
                                delete = ()
                                return Delete_Data()
                    ...
                    print('\nNIP yang diinput tidak sesuai dengan kriteria NIP. 2')
